...
function Shop() {
  ...
  //All Product Url
  const baseUrlProduct = "https://localhost:7178/api/Product/GetAll";

  //All Category Url
  const baseUrlCategory = "https://localhost:7178/api/Category/GetAll";
  ...
  async function getProductsByCategory(categoryId) {
    try {
      const url = `https://localhost:7178/api/Product/GetCategoryByProduct/${categoryId}`;
